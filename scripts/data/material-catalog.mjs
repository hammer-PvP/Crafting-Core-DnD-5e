...
export const DEFAULT_MATERIALS = Object.freeze([
  ...
  creature("aberration-membrane", "Warped Membrane", "aberration", "common", {requires:["flesh"]}),
  creature("aberration-psychic-gland", "Psychic Gland", "aberration", "rare", {requires:["flesh"], tags:["psionic"]}),
  creature("aberration-neural-fragment", "Neural Fragment", "aberration", "rare", {requires:["flesh"], tags:["psionic"]}),
  ...
  creature("beast-meat", "Beast Meat", "beast", "common", {requires:["flesh"]}),
  creature("beast-venom-gland", "Beast Venom Gland", "beast", "rare", {requires:["venom"]}),
  creature("beast-prime-marrow", "Prime Beast Marrow", "beast", "rare", {requires:["bone"]}),
  ...
  creature("celestial-feather", "Consecrated Feather", "celestial", "common", {requires:["feather"]}),
  creature("celestial-luminous-bone", "Luminous Bone", "celestial", "rare", {requires:["bone"], tags:["radiant"]}),
  creature("celestial-astral-fragment", "Astral Fragment", "celestial", "rare", {tags:["planar"]}),
  ...
  creature("construct-conductor", "Arcane Conductor", "construct", "common", {tags:["arcane"]}),
  creature("construct-rune-core", "Runic Core", "construct", "rare", {tags:["arcane"]}),
  creature("construct-animation-crystal", "Animation Crystal", "construct", "rare", {tags:["arcane","crystal"]}),
  ...
  creature("dragon-claw", "Dragon Claw", "dragon", "common", {requires:["claw"]}),
  creature("dragon-elemental-gland", "Draconic Elemental Gland", "dragon", "rare", {requires:["flesh"], tags:["elemental"]}),
  creature("dragon-marrow", "Dragon Marrow", "dragon", "rare", {requires:["bone"]}),
  ...
  creature("elemental-condensate", "Elemental Condensate", "elemental", "common", {tags:["elemental"]}),
  creature("elemental-core", "Elemental Core", "elemental", "rare", {tags:["elemental"]}),
  creature("elemental-planar-shard", "Planar Elemental Shard", "elemental", "rare", {tags:["elemental","planar"]}),
  ...
  creature("fey-glamour-dust", "Glamour Dust", "fey", "common", {tags:["fey","illusion"]}),
  creature("fey-ethereal-fragment", "Fey Ethereal Fragment", "fey", "rare", {tags:["fey","planar"]}),
  creature("fey-enchantment-residue", "Enchantment Residue", "fey", "rare", {tags:["fey","enchantment"]}),
  ...
  creature("fiend-profane-ash", "Profane Ash", "fiend", "common", {tags:["fiend"]}),
  creature("fiend-profane-horn", "Profane Horn", "fiend", "rare", {requires:["horn"], tags:["fiend"]}),
  creature("fiend-abyssal-fragment", "Abyssal Fragment", "fiend", "rare", {tags:["fiend","planar"]}),
  ...
  creature("giant-blood", "Giant Blood", "giant", "common", {requires:["blood"]}),
  creature("giant-tendon", "Giant Tendon", "giant", "rare", {requires:["flesh"]}),
  creature("giant-marrow", "Giant Marrow", "giant", "rare", {requires:["bone"]}),
  ...
  creature("humanoid-worked-metal", "Worked Metal", "humanoid", "common", {tags:["metal","trade"]}),
  creature("humanoid-alchemical-reagent", "Alchemical Reagent", "humanoid", "rare", {tags:["alchemy","trade"]}),
  creature("humanoid-fine-gemstone", "Fine Gemstone", "humanoid", "rare", {tags:["gem","trade"]}),
  ...
  creature("monstrosity-feather", "Monster Feather", "monstrosity", "common", {requires:["feather"]}),
  creature("monstrosity-arcane-organ", "Arcane Organ", "monstrosity", "rare", {requires:["flesh"], tags:["arcane"]}),
  creature("monstrosity-venom-gland", "Monstrous Venom Gland", "monstrosity", "rare", {requires:["venom"]}),
  ...
  creature("ooze-enzyme", "Ooze Enzyme", "ooze", "common", {requires:["amorphous"]}),
  creature("ooze-viscous-core", "Viscous Core", "ooze", "rare", {requires:["amorphous"]}),
  creature("ooze-concentrate", "Ooze Concentrate", "ooze", "rare", {requires:["amorphous"]}),
  ...
  creature("plant-spore", "Magical Spore", "plant", "common", {requires:["plant"]}),
  creature("plant-living-root", "Living Root", "plant", "rare", {requires:["plant"]}),
  creature("plant-enchanted-petal", "Enchanted Petal", "plant", "rare", {requires:["plant"]}),
  ...
  creature("undead-ectoplasm", "Ectoplasm", "undead", "common", {requires:["incorporeal"], tags:["spirit"]}),
  creature("undead-corrupted-marrow", "Corrupted Marrow", "undead", "rare", {requires:["bone"], tags:["necrotic"]}),
  creature("undead-spiritual-residue", "Spiritual Residue", "undead", "rare", {tags:["spirit","necrotic"]}),
  ...
  gathering("gathering-blackwater-flower", "Blackwater Flower", "flora", "rare", {biomes:["swamp"], tags:["flower"]}),
  gathering("gathering-ghost-orchid", "Ghost Orchid", "flora", "legendary", {biomes:["swamp","underdark"], tags:["flower","arcane"]}),
  ...
  gathering("gathering-ashen-lichen", "Ashen Lichen", "flora", "rare", {biomes:["ravine","mountain","cave"], tags:["lichen"]}),
  ...
  gathering("gathering-silver-ore", "Silver Ore", "mineral", "rare", {biomes:["cave","mountain"], tags:["metal"]}),
  gathering("gathering-raw-crystal", "Raw Crystal", "mineral", "common", {biomes:["cave","ravine"], tags:["crystal"]}),
  ...
  profession("trade-leather-straps", "Leather Straps", "trade", "common", {tags:["leather","craft"]}),
  profession("trade-iron-ingot", "Iron Ingot", "trade", "common", {tags:["metal","smithing"]}),
  profession("trade-steel-ingot", "Steel Ingot", "trade", "common", {tags:["metal","smithing"]}),
  ...
  profession("trade-refined-pigment", "Refined Pigment", "trade", "rare", {tags:["craft","alchemy"]}),
  profession("trade-masterwork-alloy", "Masterwork Alloy", "trade", "legendary", {tags:["metal","smithing"]}),

...
const ICON_SETS = Object.freeze({
  ...
  "prairie_truffle": Object.freeze([
    "icons/consumables/mushrooms/convex-bolete-brown.webp",
    "icons/consumables/mushrooms/bell-shiitake-brown.webp",
    "icons/consumables/mushrooms/umbonate-brown.webp",
  ]),
  "elven_root": Object.freeze([
    "icons/commodities/materials/plant-sprout-brown-green.webp",
    "icons/consumables/plants/sprout-leaf-herb-green.webp",
    "icons/magic/nature/root-vine-leaves-green.webp",
  ]),
  "wild_berries": Object.freeze([
    "icons/consumables/fruit/berries-hanging-red.webp",
    "icons/consumables/fruit/berry-bunch-red-green.webp",
    "icons/consumables/fruit/blueberry-cluster-blue.webp",
  ]),
  "wild_nuts": Object.freeze([
    "icons/consumables/nuts/hazelnuts-group-orange.webp",
    "icons/consumables/nuts/walnut-shelled-brown.webp",
    "icons/consumables/nuts/chestnut-american-green-brown.webp",
  ]),
  "wild_honey": Object.freeze([
  ...
  "wheat": Object.freeze([
    ...
    "icons/consumables/grains/wheat-gold.webp",
    "icons/commodities/flowers/wheat-bundle.webp",
  ]),
  "corn": Object.freeze([
    "icons/consumables/vegetable/corn-cob-green-yellow.webp",
    "icons/consumables/vegetable/corn-cob-brown.webp",
    "icons/containers/bags/sack-open-grain-tan.webp",
  ]),
  ...
  "rice": Object.freeze([
    "icons/consumables/grains/sack-rice-open-brown.webp",
    "icons/consumables/grains/sack-rice-flour-brown.webp",
    "icons/containers/bags/sack-open-grain-tan.webp",
  ]),
  "oats": Object.freeze([
    "icons/consumables/grains/sack-oats-glowing-white.webp",
    "icons/containers/bags/sack-open-grain-red-tan.webp",
    "icons/consumables/grains/wheat-yellow.webp",
  ]),
  ...
  "potato": Object.freeze([
    ...
    "icons/consumables/vegetable/root-potato-sprout-brown.webp",
  ]),
  "onion": Object.freeze([
    "icons/consumables/vegetable/onion-yellow.webp",
    "icons/consumables/vegetable/onion-red.webp",
    "icons/consumables/vegetable/leek-onion-green.webp",
  ]),
  "garlic": Object.freeze([
    "icons/consumables/vegetable/garlic-white.webp",
    "icons/consumables/vegetable/garlic-hardneck-purple.webp",
    "icons/consumables/vegetable/garlic-lautrec-pink.webp",
  ]),
  "carrot": Object.freeze([
    "icons/consumables/vegetable/root-carrot-orange.webp",
    "icons/consumables/vegetable/root-carrot-fat-orange.webp",
    "icons/consumables/vegetable/root-carrot-yellow.webp",
  ]),
  "cabbage": Object.freeze([
    "icons/consumables/vegetable/cabbage-head-leafy-green.webp",
    "icons/consumables/vegetable/cabbage-head-red-purple.webp",
    "icons/consumables/vegetable/cabbage-nappa-leafy-green.webp",
  ]),
  "peas": Object.freeze([
    "icons/consumables/vegetable/peas-pod-green.webp",
    "icons/consumables/vegetable/peas-pods-green.webp",
    "icons/consumables/vegetable/peas-pod-cracked-green.webp",
  ]),
  "beans": Object.freeze([
    "icons/consumables/vegetable/lima-beans-pod-brown.webp",
    "icons/consumables/vegetable/peas-pod-cracked-green.webp",
    "icons/consumables/vegetable/peas-pods-green.webp",
  ]),
  "apple": Object.freeze([
  ...
  "eggs": Object.freeze([
    "icons/consumables/eggs/egg-speckled-tan.webp",
    "icons/consumables/eggs/egg-broken-yolk-yellow.webp",
    "icons/consumables/eggs/egg-cracked-white.webp",
  ]),
  "honey": Object.freeze([
    "icons/consumables/potions/potion-bottle-corked-stopper-yellow.webp",
    "icons/consumables/food/honey-beehive-brown.webp",
    "icons/consumables/potions/bottle-round-corked-yellow.webp",
  ]),
  "thread": Object.freeze([
    "icons/commodities/cloth/thread-spindle-white.webp",
    "icons/commodities/cloth/thread-and-needle.webp",
    "icons/commodities/cloth/thread-spindle-grey.webp",
  ]),
  "cloth": Object.freeze([
    "icons/commodities/cloth/cloth-roll-tan.webp",
    "icons/commodities/cloth/cloth-scraps-plain.webp",
    "icons/commodities/cloth/cloth-green-folded.webp",
  ]),
  "twine": Object.freeze([
    "icons/tools/fishing/reel-simple-string-tan.webp",
    "icons/tools/fishing/reel-simple-string-white.webp",
    "icons/sundries/survival/rope-coiled-tan.webp",
  ]),
  "wax": Object.freeze([
    "icons/sundries/lights/candle-unlit-tan.webp",
    "icons/sundries/lights/candle-unlit-white.webp",
    "icons/sundries/lights/candle-unlit-yellow.webp",
  ]),
  ...
  "distilled_extract": Object.freeze([
    "icons/consumables/potions/bottle-pear-corked-blue.webp",
    "icons/consumables/potions/bottle-round-label-cork-blue.webp",
    "icons/consumables/potions/potion-flask-corked-cyan.webp",
  ]),
  "binding_agent": Object.freeze([
    "icons/consumables/potions/bottle-round-label-cork-yellow.webp",
    "icons/consumables/potions/bottle-conical-corked-yellow.webp",
    "icons/consumables/potions/potion-flask-corked-yellow.webp",
  ]),
  "alchemical_catalyst": Object.freeze([
    "icons/consumables/potions/potion-tube-corked-bubbling-green.webp",
    "icons/consumables/potions/bottle-conical-bubbling-blue.webp",
    "icons/commodities/materials/bowl-powder-teal.webp",
  ]),
  "copper_ingot": Object.freeze([
    "icons/commodities/metal/ingot-copper.webp",
    "icons/commodities/metal/ingot-hammered-copper.webp",
    "icons/commodities/metal/ingot-stamped-copper.webp",
  ]),
  "gold_ingot": Object.freeze([
    "icons/commodities/metal/ingot-gold.webp",
    "icons/commodities/metal/ingot-hammered-gold.webp",
    "icons/commodities/metal/ingot-plain-gold.webp",
  ]),
  "mithral_ingot": Object.freeze([
    "icons/commodities/metal/ingot-teal.webp",
    "icons/commodities/metal/ingot-stack-teal.webp",
    "icons/commodities/metal/ingot-rough-white.webp",
  ]),
  "adamantine_ingot": Object.freeze([
    "icons/commodities/metal/ingot-stamped-green.webp",
    "icons/commodities/metal/ingot-stamped-steel.webp",
    "icons/commodities/metal/ingot-worn-steel.webp",
  ]),
  "cut_gem": Object.freeze([
  ...
  "monstrous_flesh": Object.freeze([
    "icons/consumables/meat/steak-alien-orange.webp",
    "icons/consumables/meat/steak-alien-pink.webp",
    "icons/consumables/meat/steak-bone-magenta.webp",
  ]),
  "monstrous_blood": Object.freeze([
    "icons/consumables/potions/bottle-bulb-corked-glowing-red.webp",
    "icons/consumables/potions/flask-corked-red-glow.webp",
    "icons/consumables/potions/potion-tube-corked-glowing-red.webp",
  ]),
  "monster_fang": Object.freeze([
    "icons/commodities/bones/tooth-spiked-brown.webp",
    "icons/commodities/bones/tooth-canine-tan.webp",
    "icons/commodities/bones/teeth-sharp-white.webp",
  ]),
  "monstrous_bone": Object.freeze([
    "icons/commodities/bones/skull-monster-beige.webp",
    "icons/commodities/bones/bone-jaw-teeth-grey.webp",
    "icons/commodities/bones/bone-broken-brown.webp",
  ]),
  "monstrous_eye": Object.freeze([
    "icons/commodities/biological/eye-lizard-orange-red.webp",
    "icons/commodities/biological/eye-brown-red.webp",
    "icons/commodities/biological/eye-red-pink.webp",
  ]),
  "monstrous_gland": Object.freeze([
    "icons/commodities/biological/organ-bladder-red.webp",
    "icons/commodities/biological/organ-stomach.webp",
    "icons/commodities/biological/organ-liver-red.webp",
  ]),

  "hunt_rabbit_basic": Object.freeze([
    "icons/consumables/meat/drumstick-bone-pink.webp",
    "icons/consumables/meat/hock-leg-pink-brown.webp",
    "icons/consumables/meat/shank-bone-pink.webp",
  ]),
  "hunt_rabbit_rich": Object.freeze([
    "icons/consumables/meat/hock-leg-pink-brown.webp",
    "icons/consumables/meat/round-steak-fat-brown.webp",
    "icons/consumables/meat/lamb-chop-raw-red.webp",
  ]),
  "hunt_rabbit_premium": Object.freeze([
    "icons/consumables/meat/steak-marbled.webp",
    "icons/consumables/meat/round-steak-fat-brown.webp",
    "icons/consumables/meat/steak-glowing-fatty-white.webp",
  ]),
  "hunt_hare_basic": Object.freeze([
    "icons/consumables/meat/hock-leg-red-brown.webp",
    "icons/consumables/meat/hock-bone-raw-pink.webp",
    "icons/consumables/meat/shank-bone-red.webp",
  ]),
  "hunt_hare_rich": Object.freeze([
    "icons/consumables/meat/shank-bone-pink.webp",
    "icons/consumables/meat/shank-bone-flat-red.webp",
    "icons/consumables/meat/round-steak-fat-brown.webp",
  ]),
  "hunt_hare_premium": Object.freeze([
    "icons/consumables/meat/round-steak-fat-brown.webp",
    "icons/consumables/meat/steak-marbled.webp",
    "icons/consumables/meat/roast-skin-red-pink.webp",
  ]),
  "hunt_bird_basic": Object.freeze([
    "icons/consumables/meat/chicken-breast-raw-pink.webp",
    "icons/consumables/meat/drumstick-bone-pink.webp",
    "icons/consumables/meat/plate-hock-bone-pink.webp",
  ]),
  "hunt_bird_rich": Object.freeze([
    "icons/consumables/meat/plate-hock-bone-pink.webp",
    "icons/consumables/meat/roast-bone-red-white.webp",
    "icons/consumables/meat/hock-leg-pink-brown.webp",
  ]),
  "hunt_bird_premium": Object.freeze([
    "icons/consumables/meat/roast-bone-red-white.webp",
    "icons/consumables/meat/steak-marbled.webp",
    "icons/consumables/meat/steak-glowing-fatty-white.webp",
  ]),
  "hunt_boar_basic": Object.freeze([
    "icons/consumables/meat/side-pork-fat-skin-pink.webp",
    "icons/consumables/meat/hock-bones-skin-red.webp",
    "icons/consumables/meat/hock-leg-skin-brown.webp",
  ]),
  "hunt_boar_rich": Object.freeze([
    "icons/consumables/meat/hock-fatty-skin-brown-red.webp",
    "icons/consumables/meat/side-pork-fat-skin-pink.webp",
    "icons/consumables/meat/roast-skin-red-pink.webp",
  ]),
  "hunt_boar_premium": Object.freeze([
    "icons/consumables/meat/roast-skin-red-pink.webp",
    "icons/consumables/meat/steak-marbled.webp",
    "icons/consumables/meat/steak-glowing-fatty-white.webp",
  ]),
  "hunt_goat_basic": Object.freeze([
    "icons/consumables/meat/lamb-chop-raw-red.webp",
    "icons/consumables/meat/lamb-chop-rack-raw-red.webp",
    "icons/consumables/meat/hock-leg-skin-brown.webp",
  ]),
  "hunt_goat_rich": Object.freeze([
    "icons/consumables/meat/lamb-chop-rack-raw-red.webp",
    "icons/consumables/meat/shank-aged-red.webp",
    "icons/consumables/meat/round-steak-fat-brown.webp",
  ]),
  "hunt_goat_premium": Object.freeze([
    "icons/consumables/meat/shank-aged-red.webp",
    "icons/consumables/meat/steak-marbled.webp",
    "icons/consumables/meat/roast-skin-red-pink.webp",
  ]),
  "hunt_deer_basic": Object.freeze([
    "icons/consumables/meat/shank-bone-red.webp",
    "icons/consumables/meat/shank-bone-flat-red.webp",
    "icons/consumables/meat/ribs-bone-raw-red.webp",
  ]),
  "hunt_deer_rich": Object.freeze([
    "icons/consumables/meat/shank-bone-flat-red.webp",
    "icons/consumables/meat/ribs-bone-raw-red.webp",
    "icons/consumables/meat/steak-raw-red-pink.webp",
  ]),
  "hunt_deer_premium": Object.freeze([
    "icons/consumables/meat/ribs-bones-glowing-pink.webp",
    "icons/consumables/meat/steak-marbled.webp",
    "icons/consumables/meat/steak-glowing-fatty-white.webp",
  ]),
  "hunt_elk_basic": Object.freeze([
    "icons/consumables/meat/hock-leg-skin-brown.webp",
    "icons/consumables/meat/shank-bone-skin-red.webp",
    "icons/consumables/meat/ribs-bone-raw-red.webp",
  ]),
  "hunt_elk_rich": Object.freeze([
    "icons/consumables/meat/shank-bone-skin-red.webp",
    "icons/consumables/meat/roast-bone-red-white.webp",
    "icons/consumables/meat/shank-aged-red.webp",
  ]),
  "hunt_elk_premium": Object.freeze([
    "icons/consumables/meat/steak-glowing-fatty-white.webp",
    "icons/consumables/meat/steak-marbled.webp",
    "icons/consumables/meat/ribs-bones-glowing-pink.webp",
  ]),
...
const MATERIAL_ICON_SET = Object.freeze({
  ...
  "monstrosity-flesh": "monstrous_flesh",
  "monstrosity-blood": "monstrous_blood",
  "monstrosity-fang": "monster_fang",
  "monstrosity-bone": "monstrous_bone",
  "monstrosity-eye": "monstrous_eye",
  "monstrosity-gland": "monstrous_gland",
  ...
  "creature-amphibious-membrane": "membrane",
  "creature-spider-silk": "membrane",
  "ooze-gel": "ooze_gel",
  "ooze-acid": "ooze_acid",
  ...
  "essence-air": "elemental_condensate",
  ...
  "gathering-adamantine-powder": "profane_ash",
  ...
  "gathering-prairie-truffle": "prairie_truffle",
  "gathering-elven-root": "elven_root",
  "gathering-wild-berries": "wild_berries",
  "gathering-wild-nuts": "wild_nuts",
  "gathering-wild-honey": "wild_honey",
  "hunt-rabbit-basic": "hunt_rabbit_basic",
  "hunt-rabbit-rich": "hunt_rabbit_rich",
  "hunt-rabbit-premium": "hunt_rabbit_premium",
  "hunt-hare-basic": "hunt_hare_basic",
  "hunt-hare-rich": "hunt_hare_rich",
  "hunt-hare-premium": "hunt_hare_premium",
  "hunt-game-bird-basic": "hunt_bird_basic",
  "hunt-game-bird-rich": "hunt_bird_rich",
  "hunt-game-bird-premium": "hunt_bird_premium",
  "hunt-wild-boar-basic": "hunt_boar_basic",
  "hunt-wild-boar-rich": "hunt_boar_rich",
  "hunt-wild-boar-premium": "hunt_boar_premium",
  "hunt-wild-goat-basic": "hunt_goat_basic",
  "hunt-wild-goat-rich": "hunt_goat_rich",
  "hunt-wild-goat-premium": "hunt_goat_premium",
  "hunt-deer-basic": "hunt_deer_basic",
  "hunt-deer-rich": "hunt_deer_rich",
  "hunt-deer-premium": "hunt_deer_premium",
  "hunt-elk-basic": "hunt_elk_basic",
  "hunt-elk-rich": "hunt_elk_rich",
  "hunt-elk-premium": "hunt_elk_premium",
  "trade-wheat": "wheat",
  "trade-corn": "corn",
  "trade-barley": "barley",
  "trade-rice": "rice",
  ...
  "trade-twine": "twine",
  "trade-wax": "wax",
  "trade-alcohol": "alcohol",
  "trade-distilled-extract": "distilled_extract",
  "trade-binding-agent": "binding_agent",
  "trade-alchemical-catalyst": "alchemical_catalyst",
  "trade-copper-ingot": "copper_ingot",
  "trade-gold-ingot": "gold_ingot",
  "trade-mithral-ingot": "mithral_ingot",
  "trade-adamantine-ingot": "adamantine_ingot",
  "trade-cut-gem": "cut_gem",
  "trade-refined-crystal": "refined_crystal",
  "trade-perfect-crystal": "perfect_crystal",
});

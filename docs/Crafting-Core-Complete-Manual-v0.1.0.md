...
subtitle: "Complete Manual - v0.1.0"
author: "Hammer-PvP"
...
This manual documents the features that are part of the v0.1.0 stable foundation. It intentionally does not describe speculative future systems.
...
Both are GM-managed private world libraries.
...
https://github.com/hammer-PvP/Crafting-Core-DnD-5e/blob/main/docs/Crafting-Core-Complete-Manual-v0.1.0.pdf
...
v0.1.0 is a stable foundation release. The core Recipe/Knowledge/Project lifecycle was live-tested before promotion, and this release does not add an unvalidated mechanical system merely to justify the version number.

Future feature work should build on this foundation rather than reopening the stable Knowledge lifecycle without a specific regression or design reason.
